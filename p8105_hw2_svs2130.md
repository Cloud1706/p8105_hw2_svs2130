...
There are 822, 787 816 822observations and 9, 4 3 12 in the Polls per
month dataset, snp data set, unemployment dataset and the final merged
dataset respectively. The final dataset includes some key variables like
`ncolnames(Final)`. The range of yeats 1947 to 1947
...
![](p8105_hw2_svs2130_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
